...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String POPULATE_TABLE_1 = "INSERT INTO " + Blocks + "(" + column_blockno + ", " + column_name + ", " +
                ...
                + "(" + "83, " + "'School of Life Sciences & Chemical Technology', " + "'These five courses are endorsed by industry experts, renowned research institutes and top universities locally and abroad. LSCT also has close links with organizations such as National Parks Board and PUB, Singapore’s National Water Agency. Our strong partnerships will provide you with lots of opportunities to learn in a real-world setting.', " + "'LSCT', " + "'LSCT'" + "),"
